...
const PROCESS_OPTIONS = [
  'IPQC-07 Thickness Wall Measurement',
  'IPQC-01 Tensile Measurement',
  'IPQC-02 Surface Roughness',
  'IPQC-03 X-Ray Plating & Film Thickness',
  'IPQC-04 Coating & Film Thickness',
  'IPQC-05 Cutting Dimension & Tolerance',
  'IPQC-06 Mixing Inspection & Viscosity',
  'IQC-01 Billet Incoming (Chemical & Visual)',
  'IQC-02 Chemical Incoming Inspection',
  'IQC-03 Zn Wire Incoming Inspection',
  'OQC-01 FG Pre-Shipment Tag & Packaging',
